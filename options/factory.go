...
// New creates new ProcessingOptions instance
func (f *Factory) New() *ProcessingOptions {
	po := ProcessingOptions{
		...
		Sharpen:           0,
		Dpr:               1,
		Watermark:         WatermarkOptions{Opacity: 1, Position: GravityOptions{Type: GravityCenter}, factory: f},
