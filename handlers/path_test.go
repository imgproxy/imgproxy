...
func (s *PathTestSuite) TestParsePath() {
	testCases := []struct {
		...
		{
			name:          "PathWithPlainUrlRedenormalization",
		...
		{
			name:          "PathWithOptionsSeparatorUnescapingPLain",
			requestPath:   "/dummy_signature/rs%3Afill%3A300%3A200/plain/https://example.com/path/to/image.jpg",
			expectedPath:  "rs:fill:300:200/plain/https://example.com/path/to/image.jpg",
			expectedSig:   "dummy_signature",
			expectedError: false,
		},
		{
			name:          "PathWithOptionsSeparatorUnescapingBas64",
			requestPath:   "/dummy_signature/rs%3Afill%3A300%3A200/abc/abc",
			expectedPath:  "rs:fill:300:200/abc/abc",
			expectedSig:   "dummy_signature",
			expectedError: false,
		},
		{
